      ...
      <Container size="content">
        <div className="grid gap-6 lg:grid-cols-[0.72fr_1.28fr]">
          <div>
            ...
            <h2 className="type-section mt-3 text-studio-text">Scope, pricing and ownership in plain terms.</h2>
          </div>

          <div className="grid gap-0 border-t border-studio-line">
            {engagementFaqs.map((faq) => (
              <details className="group border-b border-studio-line py-4" key={faq.question}>
                ...
                <p className="type-small mt-3 max-w-3xl text-studio-muted">{faq.answer}</p>
              </details>
            ))}
          </div>
        </div>
