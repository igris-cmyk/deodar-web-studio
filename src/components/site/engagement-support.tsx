        ...
        <Container size="wide">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.78fr)_minmax(0,1.22fr)] lg:items-end">
            <div>
              ...
              <h2 className="type-section mt-3 max-w-2xl text-studio-text">{postLaunchPlans.heading}</h2>
            </div>
          ...
          <div className="mt-9 border-y border-studio-line">
            {postLaunchPlans.plans.map((plan, index) => (
              <article
                className="grid gap-5 border-t border-studio-line py-5 first:border-t-0 lg:grid-cols-[3rem_minmax(12rem,0.55fr)_minmax(0,1fr)_minmax(12rem,0.55fr)] lg:items-start"
                key={plan.name}
              >
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-semibold text-studio-textSoft">{plan.price}</p>
                  <p className="type-small mt-2 text-studio-muted">{plan.summary}</p>
                </div>
        ...
        <Container size="wide">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,0.7fr)_minmax(0,1.3fr)] lg:items-end">
            <div>
              ...
              <h2 className="type-section mt-3 max-w-2xl text-studio-paperText">{engagementFit.heading}</h2>
            </div>
          ...
          <div className="mt-8 grid gap-8 border-y border-studio-paperLine py-6 lg:grid-cols-2">
